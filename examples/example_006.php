...
// Change NORMAL text style to use font family "Times" and set the size to 11 points
$tsNormal = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::NORMAL);
$tsNormal->setFontFamily("Times");
$tsNormal->setSize(11.0);

// Change the TABLE_? text styles to use font family "Courier"
$ts = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_HEADER);
$ts->setFontFamily("Courier");
$ts = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_ROW);
$ts->setFontFamily("Courier");
$ts = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_TOTAL);
$ts->setFontFamily("Courier");
$ts = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_SUBTOTAL);
$ts->setFontFamily("Courier");

// Change the color of FOOTER and HEADER text styles
$ts = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::FOOTER);
$ts->setTextColor("#CCCCCC");
$ts = ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::HEADER);
$ts->setTextColor("#00CC00");

// Print example text with all predefined text styles - to show the adjustments made above
$body->AddText("NORMAL (Times, 11 points)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::NORMAL));
...
$body->AddText("TABLE_HEADER is the NORMAL style but one point smaller and bold (courier!)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_HEADER));
$body->AddText("TABLE_ROW is the NORMAL style but one point smaller (courier!)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_ROW));
$body->AddText("TABLE_SUBTOTAL is the NORMAL style but one point smaller and italic (courier!)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_SUBTOTAL));
$body->AddText("TABLE_TOTAL is the NORMAL style but one point smaller and bold (courier!)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::TABLE_TOTAL));
$body->AddText("FOOTER is the NORMAL style but one point smaller (grey!)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::FOOTER));
$body->AddText("HEADER is the NORMAL style but one point smaller (green!)", ReportLib\TextStyles::getTextStyle(ReportLib\TextStyles::HEADER));
