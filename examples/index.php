...
<p>For more information see <a href="https://adiuvaris.ch/reportlib" title="ReportLib" target="_blank">ReportLib</a></p>

<h2>ReportLib basics</h2>
<p>
    <ol>
    <li><b>Simple empty report with paper format A4 in portrait mode with default margins, showing the printable area:</b> [<a href="example_001.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-1" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Simple empty report with paper format Letter in landscape mode with a margin of one inch on top and half an inch on the other sides. A thin line around the printable area:</b>  [<a href="example_002.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-2" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Report with default format and three paragraphs of text on it:</b>  [<a href="example_003.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-3" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Report with text paragraphs showing different formatting possibilities:</b>  [<a href="example_004.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-4" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Using the predefined text styles:</b>  [<a href="example_005.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-5" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Adjust the predefined text styles to use other font families or sizes and colors:</b>  [<a href="example_006.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-6" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Create new named text styles with any desired settings:</b>  [<a href="example_007.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-7" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Adding horizontal lines with convenience functions and manually with LineFrames and Pens: </b> [<a href="example_008.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-8" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Automatic and manual page breaks and changes of the page formats and margins:</b>  [<a href="example_009.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-9" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Adding images to a report:</b>  [<a href="example_010.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-10" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Adding barcodes to a report: </b> [<a href="example_011.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-11" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Add a simple table to a report:</b>  [<a href="example_012.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-12" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Add a table to a report using the full width:</b>  [<a href="example_013.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-13" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>A table using percent values for the widths of the columns:</b>  [<a href="example_014.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-14" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>A table using more space than available - line break: </b> [<a href="example_015.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-15" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Use row types for a table:</b>  [<a href="example_016.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-16" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Add some border and some grid lines to a table:</b>  [<a href="example_017.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-17" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Use text styles in tables: </b> [<a href="example_018.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-18" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Tables that spread over more than one page:</b>  [<a href="example_019.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-19" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>How to use BoxFrames:</b>  [<a href="example_020.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-20" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Use BoxFrames to place and format texts: </b> [<a href="example_021.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-21" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>BoxFrames in SerialFrames: </b> [<a href="example_022.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-22" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Use FixposFrames to place content on an absolute position on the report: </b> [<a href="example_023.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-23" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Header and footer: </b> [<a href="example_024.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-24" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Different headers and footers via PageFrames:</b>  [<a href="example_025.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-25" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>BoxFrames using percent values as width:</b>  [<a href="example_026.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-26" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Table rows with joined columns:</b>  [<a href="example_027.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-27" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Exceptions:</b>  [<a href="example_028.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-28" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>Example report</b>  [<a href="example_029.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-29" title="PHP [new window]" target="_blank">Source</a>]
    ...
    <li><b>More complex report</b>  [<a href="example_030.php" title="PDF [new window]" target="_blank">PDF</a>] [<a href="https://adiuvaris.ch/reportlib/example-30" title="PHP [new window]" target="_blank">Source</a>]
