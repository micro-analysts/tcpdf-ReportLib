...
// Add a data row as title for the width row
$row = new ReportLib\TableRow('T');
$row->setText("frametype", "From the next row on there is the real data. There is a join from the first to the last column.");
$row->setJoinStart(0);
$row->setJoinEnd(3);
$table->addDataRow($row);
...
$report->output(__DIR__ . "/example_027.pdf", 'I');
