...
// Add a data row to the table with the column widths - row type 'subtotal'
...
// Add a data row to the table - row type 'Detail'
...
// Add a second data row to the table - row type 'Detail'
$row = new ReportLib\TableRow('D');
...
// Add a third data row to the table - row type 'Detail'
$row = new ReportLib\TableRow('D');
...
// Add a total data row to the table - row type 'Total'
...
$report->output(__DIR__ . "/example_016.pdf", 'I');
